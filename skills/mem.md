---
name: mem
description: Search and manage Claude's persistent memory stored in a single portable .memvid file
---

# Memory Search Skill

You have access to a persistent memory system powered by Memvid. All your observations, discoveries, and learnings are stored in a single `.claude/mind.mv2` file.
